...
const ABBREVIATION_EXPANSIONS: Array<[RegExp, string]> = [
  [/\bRNP\b/g, "RNP (Расчет Недельного Плана, haftaliy reja hisob-kitobi, weekly plan calculation)"],
  [/\bKPI\b/g, "KPI (Key Performance Indicator, asosiy samaradorlik ko'rsatkichi)"],
  [/\bROP\b/g, "ROP (Руководитель отдела продаж, sotuv bo'limi rahbari, sales department head)"],
  [/\bCRM\b/g, "CRM (Customer Relationship Management, mijozlar bilan munosabatlar boshqaruvi)"],
];
